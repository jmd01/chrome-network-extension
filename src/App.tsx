...
function App() {
    ...
    const [postDataColumns, setPostDataColumns] = useState<Set<string>>(new Set<string>());
    ...
    useEffect(() => {
        function onRequestFinish(request: chrome.devtools.network.Request) {
            ...
            if (request.request.postData?.text && request.request.postData?.mimeType === "application/json") {
